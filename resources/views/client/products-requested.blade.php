    ...
    <div class="row justify-content-center">
        <div class="container">
            <ul class="nav nav-tabs" id="myTab">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#nav_tab_1">All Products <span class="text-primary">{{ count($requested_products) }}</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#nav_tab_2">Pending <span class="text-danger">{{ count($pending_requested_products) }}</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#nav_tab_3">Approved <span class="text-success">{{ count($approved_requested_products) }}</span></a>
                </li>
            </ul>
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($requested_products as $products)
                                    <tr>
                                        ...
                                        <td>{{ round(($products->product_length * $products->product_width * $products->product_height)/1728, 2) }} cuft.</td>
                                        <td>{{ $products->weight }}</td>
                                        <td><img src="{{ asset('uploads/'.$products->product_picture) }}" alt="{{ $products->product_name }}"></td>
